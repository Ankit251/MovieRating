...
<body>
	<h1> <marquee><u>WELCOME  TO  JOB PORTAL. </u></marquee></h1>
	<h2> <a href="admin.php"><img src="image/home.png"></a>Update Profile Here</h2>
	<div class="pf">
		<form action="" method="POST" autocomplete="off">
			<div class="fp">
				<input type="text" name="name" value="<?php echo ($result['username']);?>" required></p>
...
if(isset($_POST['update']))
{
	...
	if($n!="" && $e!="" && $p!="")
		{
			$qu = "UPDATE admin set username='$n', email='$e', password='$p' ";
